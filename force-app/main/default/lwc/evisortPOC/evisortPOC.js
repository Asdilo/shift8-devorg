...
export default class EvisortPOC extends LightningElement {
  ...
  logoSvgUrl =
    Evisort_Resources + "/evisortResources/evisortLogo.svg#colorLogo";
  iconSvgUrl =
    Evisort_Resources + "/evisortResources/evisortIcon.svg#colorIcon";
  apiSetupGifUrl = Evisort_Resources + "/evisortResources/apiKeySetup.gif";
  namedCredentialGifUrl =
    Evisort_Resources + "/evisortResources/namedCredentialSetup.gif";
